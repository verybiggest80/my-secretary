    ...
    "2026-09": {   /* 九月 */
      ...
      vsDuty: {
        ...
        rounds: {
          ...
          23: [{ shift: "A", region: "A1,A2,A8B1,B2,B3", doctor: "林均叡" }, { shift: "A", region: "A3,A5,A6,A7,A9H1", doctor: "蔡凱帆" }, { shift: "A", region: "B5,B6,B7,B8,B9H2", doctor: "陳靖博" }, { shift: "A", region: "H3,H5,H6,H7,H8,H9", doctor: "賴育城" }, { shift: "B", region: "A1,A2,A8B1,B2,B3", doctor: "許淳惟" }, { shift: "B", region: "A3,A5,A6,A7,A9H1", doctor: "許淳惟" }, { shift: "B", region: "B5,B6,B7,B8,B9H2", doctor: "李文欽" }, { shift: "B", region: "H3,H5,H6,H7,H8,H9", doctor: "李宜蓉" }, { shift: "C", region: "A3,A5,A6,A7,A9H1", doctor: "王麒翔" }, { shift: "C", region: "B5,B6,B7,B8,B9", doctor: "王振宇" }],
